...
public class TodoListActivity extends AppCompatActivity implements ItemAdapter.Listener {
    ...
    private void getCurrentUser() {
        ...
        if (userLiveData != null) {
            userLiveData.observe(this, this::updateView); // observe() to be automatically notified if the results in the database change.
        }
    }

    private void getItems() {
        this.itemViewModel.getItems(USER_ID).observe(this, this::updateItemsList);   // observe() to be automatically notified and updated if changes occur to item table.
    }
